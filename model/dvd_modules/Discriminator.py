...
from model.dvd_modules.Normalization import ConditionalNorm, SpectralNorm
...
if __name__ == '__main__':
    ...
    for i in range(100):
        data = torch.randn((batch_size, 3, n_frames, 64, 64))#.cuda()
